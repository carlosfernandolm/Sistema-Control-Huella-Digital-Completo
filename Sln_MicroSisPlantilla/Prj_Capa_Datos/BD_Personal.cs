  ...
  public class BD_Personal : Cls_Conexion 
    {
      ...
      public DataTable BD_Leer_todoPersona()
        ...
        public DataTable BD_Buscar_Personal_xValor(string valor)
        {
            ...
            {
                cn.ConnectionString = Conectar();
                SqlDataAdapter da = new SqlDataAdapter("Sp_Cargar_PersonalxCI", cn);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                da.SelectCommand.Parameters.AddWithValue("@CI", valor);
                DataTable dato = new DataTable();
        ...
        public bool BD_Verificar_CiPersonal(string ci)
        {
            ...
            _With1.CommandText = "Sp_Validar_Ci";
            _With1.Connection = Cn;
            _With1.CommandTimeout = 20;
            _With1.CommandType = CommandType.StoredProcedure;
            //Parametros de entrada
            _With1.Parameters.AddWithValue("@Ci", ci);
            try
            {
                Cn.Open();
        ...
        public void BD_Eliminar_Personal(string CI)
        {
            SqlConnection cn = new SqlConnection(Conectar());

   ...
   public  class RN_Personal
    {
        ...
        public bool RN_Verificar_CiPersonal(string ci)
        {
            BD_Personal obj = new BD_Personal();
            return obj.BD_Verificar_CiPersonal(ci);
        }



        public void RN_Eliminar_Personal(string CI)
        {
            BD_Personal obj = new BD_Personal();
            obj.BD_Eliminar_Personal(CI);
        }
    }
}
